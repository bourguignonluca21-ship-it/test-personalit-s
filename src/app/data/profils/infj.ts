...
Ton alliance rare de la profondeur et de la détermination te permet de porter des projets ambitieux et porteurs de sens : tu sais transformer un idéal en plan, et un plan en action soutenue. En revanche, les compromis moraux, le cynisme et les ambiances contraires à tes convictions te démotivent profondément. Ton défi principal, c'est ton équilibre et ton ancrage : tu peux t'épuiser pour tes causes, te durcir face aux résistances, ou buter sur les réalités concrètes. Apprendre à choisir tes combats, à composer avec le réel et à te préserver rend ton engagement durable et efficace.`,
  ...
  mindsetTexte: {
    "INFJ-V1": {
      apercu: `Ton plus grand chantier n'est pas autour de toi, il est en toi. Tu portes une vocation rare à comprendre et à élever les autres, mais aussi une tendance qui peut se retourner contre toi : l'oubli de soi, l'absorption de la souffrance d'autrui, l'idéalisme qui déçoit, la réserve qui isole. La bonne nouvelle, c'est que ce qui t'épuise dans ton don est exactement là où ta croissance t'attend : apprends à te préserver, et ta vocation devient une lumière qui dure.`,
    },
    "INFJ-V2": {
      apercu: `Ton plus grand chantier n'est pas de percevoir le sens, ton intuition n'en manque jamais, c'est de le faire descendre dans le réel. Tu portes en toi une profondeur rare, mais aussi une tendance à te déconnecter du concret, à négliger ton corps et le présent, à te replier dans ta solitude. La bonne nouvelle, c'est que ce qui t'éloigne du concret est précisément le seuil de ta croissance : apprends à incarner ta profondeur, et elle prend enfin une vraie prise sur le monde.`,
    },
    "INFJ-V3": {
      apercu: `Ton plus grand chantier n'est pas de trouver une cause, tes convictions en débordent, c'est d'apprendre à la porter sans t'y consumer. Tu portes en toi une vision et une détermination rares, mais aussi une tendance à t'épuiser, à te durcir, à porter le monde seul. La bonne nouvelle, c'est que ce qui menace de te consumer désigne exactement où ta croissance se joue : apprends à durer, et ta flamme transforme vraiment le monde au lieu de te brûler.`,
    },
  },
  ...
  sectionDetail: {
    ...
    "INFJ-V1-developpement": {
      evolution: `Le Mentor que tu es ne reste pas le même toute sa vie : ta façon d'aimer et d'accompagner s'affine avec les années, et c'est l'une des transformations les plus profondes qui soient. Plus jeune, tu es tout entier dans ta vocation et ta sensibilité : comprendre, aider, accompagner, porter les autres et tes idéaux. C'est profond et beau, mais souvent déséquilibré : tu peux t'oublier complètement, absorber la souffrance des autres et t'épuiser à donner.

Avec le temps, quelque chose de précieux s'ouvre en toi. Tu comprends que tu ne peux donner durablement que si tu te préserves, que prendre soin de toi n'est pas égoïste mais nécessaire, et que tes idéaux gagnent à composer avec l'imperfection du réel. Tu apprends à poser des limites, à recevoir, à te livrer, à t'ancrer dans le concret. Dans ta pleine maturité, tu deviens un mentor profond qui élève les autres sans jamais s'effacer : c'est là que tu donnes le meilleur de toi. Et ce chemin est entièrement à ta portée.`,
      etapes: [
        ...
        "Ta vocation et ta sensibilité sont à leur comble : tu comprends, tu accompagnes, tu portes les autres et tes idéaux. C'est généreux, mais souvent déséquilibré : tu t'oublies, tu absorbes la souffrance d'autrui, et te préserver ne te vient pas encore naturellement.",
        ...
        "Dans ta pleine maturité, tu es un mentor profond qui élève les autres sans s'oublier, qui sait donner et recevoir. Ta sagesse s'incarne dans le réel et ta vocation se nourrit aussi elle-même : c'est ton plein épanouissement.",
      ],
      leviersForts: [
        ...
        { titre: "Fais de ton intuition un don", texte: "Ta clairvoyance sur les êtres est une force rare. Mets-la au service de ceux que tu accompagnes, et elle transforme des vies sans jamais t'épuiser quand tu la doses bien." },
    ...
    "INFJ-V2-developpement": {
      evolution: `Le Visionnaire que tu es se transforme au fil du temps : ta profondeur ne disparaît pas, elle apprend à trouver sa place dans le monde, et c'est l'un des cheminements les plus riches qui soient. Plus jeune, tu es tout entier dans ta vie intérieure et ton intuition : percevoir, contempler, suivre l'inspiration, explorer le sens. C'est profond et beau, mais souvent déconnecté : tu peux vivre tellement dans ta tête que tu négliges le réel, ton corps et le présent, et te replier dans ta solitude.

Avec le temps, quelque chose de précieux s'ouvre en toi. Tu comprends qu'une vision qui ne s'incarne pas reste stérile, que ta profondeur gagne à descendre sur terre, et que prendre soin du concret n'est pas trahir ton âme mais l'ancrer. Tu apprends à incarner tes intuitions, à les partager, à habiter le présent. Dans ta pleine maturité, tu deviens un visionnaire profond qui sait aussi s'ancrer et transmettre, dont la sagesse éclaire le monde réel : c'est là que tu donnes le meilleur de toi. Et ce chemin est entièrement à ta portée.`,
      etapes: [
        ...
        "Tu vis pleinement à travers ton intuition et ta vie intérieure : percevoir, contempler, suivre l'inspiration. C'est riche et beau, mais souvent déconnecté : tu vis dans ta tête, tu négliges le réel, et t'ancrer ne te vient pas encore spontanément.",
        ...
        "Dans ta pleine maturité, tu es un visionnaire profond qui sait aussi s'ancrer et transmettre. Ta sagesse éclaire le monde réel au lieu de rester enfermée : c'est ton plein épanouissement.",
      ],
      leviersForts: [
      ...
      paradoxe: {
        ...
        bascule:
          "Le jour où tu comprends que t'ancrer ne trahit pas ta profondeur mais lui donne enfin une prise sur le monde, ton chemin de croissance s'ouvre pour de bon.",
      },
    },
    // ----------------------------------------------------------------- V3
    "INFJ-V3-relations": {
      ...
      blocs: [
        ...
        },
        {
          ...
          items: [
            ...
            "Quelqu'un qui veille sur toi quand tu t'oublies dans tes combats.",
    ...
    "INFJ-V3-developpement": {
      evolution: `L'Architecte d'Idéaux que tu es évolue avec les années : ta flamme ne s'éteint pas, elle apprend à brûler sans te consumer, et c'est l'un des apprentissages les plus décisifs de ta vie. Plus jeune, tu es tout entier dans tes idéaux et ton engagement : transformer, militer, porter tes convictions, vouloir changer le monde. C'est beau et puissant, mais souvent déséquilibré : tu peux t'épuiser pour tes causes, te durcir face aux résistances et te négliger jusqu'au surmenage.

Avec le temps, quelque chose de précieux s'ouvre en toi. Tu comprends que tu ne peux transformer durablement que si tu te préserves, que le monde change à son rythme, et que choisir ses combats n'est pas renoncer mais durer. Tu apprends à composer avec le réel, à t'appuyer sur les autres, à prendre soin de toi. Dans ta pleine maturité, tu deviens un architecte d'idéaux qui transforme le monde sans s'y consumer : c'est là que tu donnes le meilleur de toi. Et ce chemin est entièrement à ta portée.`,
      etapes: [
        ...
        "Dans ta pleine maturité, tu transformes le monde sans t'y consumer, alliant la vision élevée à l'ancrage concret et le don de soi au soin de soi : c'est ton plein épanouissement.",
      ],
      leviersForts: [
