...
export default function EquipesPage() {
  return (
    <div className="bg-white">
      <section className="bg-[rgba(51,164,116,0.75)] text-white text-center py-16 px-6">
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 text-center">
        ...
        <span className="inline-block bg-[#eef8f3] text-[rgba(51,164,116,0.75)] text-sm font-semibold px-4 py-2 rounded-full">
          🔧 Contenu à définir
        </span>
      </section>
    </div>
